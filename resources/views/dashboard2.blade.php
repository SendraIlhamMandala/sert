...
<head>
    ...
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="mobapp-master/css/bootstrap.min.css">
    <!-- Themify Icons -->
    <link rel="stylesheet" href="mobapp-master/css/themify-icons.css">
    <!-- Owl carousel -->
    <link rel="stylesheet" href="mobapp-master/css/owl.carousel.min.css">
    <!-- Main css -->
    <link href="mobapp-master/css/style.css" rel="stylesheet">
</head>
...
<body data-spy="scroll" data-target="#navbar" data-offset="30">
            ...
            <div class="row">
                <div class="col-md-12">
                    <nav class="navbar navbar-dark navbar-expand-lg">
                        <a class="navbar-brand" href="index.html"><img src="mobapp-master/images/logo.png"
    ...
    <header class="bg-gradient" id="home">
        <div class="container mt-5">
            <h1>SERTIFIKAT FISIP UNIGA</h1>
            <p class="tagline">website direktori sertifikat FISIP UNIGA. </p>
        </div>
        <div class=" "><img src="mobapp-master/images/sert.png" alt="phone" class="img-fluid"></div>
    </header>

    <div class="client-logos my-5">
        <div class="container text-center">
            <img src="mobapp-master/images/client-logos.png" alt="client logos" class="img-fluid">
        </div>
    </div>
    ...
    <div class="section">
        ...
        <div class="container">
            ...
            <div class="perspective-phone">
                <img src="mobapp-master/images/perspective.png" alt="perspective phone" class="img-fluid">
            </div>
        </div>
            ...
            <div class="tab-content">
                <div class="tab-pane fade show active" id="communication">
                    <div class="d-flex flex-column flex-lg-row">
                        <img src="mobapp-master/images/graphic.png" alt="graphic"
    ...
    <div class="section">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <img src="mobapp-master/images/dualphone.png" alt="dual phone" class="img-fluid">
                </div>
    ...
    <div class="section light-bg">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4">
                    <img src="mobapp-master/images/iphonex.png" alt="iphone" class="img-fluid">
                </div>
    ...
    <div class="input-group mb-3">
        ...
        <div class="input-group-append">
            ...
            <div class="section light-bg" id="gallery">
                <div class="container">
                    ...
                    <div class="img-gallery owl-carousel owl-theme">
                        <img src="mobapp-master/images/screen1.jpg" alt="image">
                        <img src="mobapp-master/images/screen2.jpg" alt="image">
                        <img src="mobapp-master/images/screen3.jpg" alt="image">
                        <img src="mobapp-master/images/screen1.jpg" alt="image">
                    </div>
                ...
                <div class="container">
                    ...
                    <div class="row pt-4">
                        <div class="col-md-6">
                            ...
                            <p class="light-font mb-5">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer
                                rutrum, urna eu pellentesque pretium, nisi nisi fermentum enim, et sagittis dolor nulla
                                vel sapien. Vestibulum sit amet mattis ante. </p>
            ...
            <div class="section bg-gradient">
                <div class="container">
                    <div class="call-to-action">
                        ...
                        <p class="tagline">Available for all major mobile and desktop platforms. Rapidiously visualize
                            optimal ROI rather than enterprise-wide methods of empowerment. </p>
                        <div class="my-4">

                            <a href="#" class="btn btn-light"><img src="mobapp-master/images/appleicon.png"
                                    alt="icon"> App Store</a>
                            <a href="#" class="btn btn-light"><img src="mobapp-master/images/playicon.png"
                                    alt="icon"> Google play</a>
                        </div>
                        <p class="text-primary"><small><i>*Works on iOS 10.0.5+, Android Kitkat and above. </i></small>
                        </p>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6 text-center text-lg-left">
                            <p class="mb-2"> <span class="ti-location-pin mr-2"></span> 1485 Pacific St, Brooklyn,
                                NY 11216 USA</p>
                            ...
                            <div class="d-block d-sm-inline-block">
                                <p class="mb-0">
                                    <span class="ti-headphone-alt mr-2"></span> <a
                                        href="tel:51836362800">518-3636-2800</a>
                                </p>
                            </div>
            ...
            <script src="mobapp-master/js/jquery-3.2.1.min.js"></script>
            <script src="mobapp-master/js/bootstrap.bundle.min.js"></script>
            <!-- Plugins JS -->
            <script src="mobapp-master/js/owl.carousel.min.js"></script>
            <!-- Custom JS -->
            <script src="mobapp-master/js/script.js"></script>
